  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HisCubit, HisState>(
      builder: (context, state) {
                      ...
                      rows: List<DataRow>.generate(
                        ...
                        (index) => DataRow(
                          cells: [
                            ...
                            DataCell(Center(
                                child: CustomText(
                                    text: clinics[index].subscriptionTo!))),
                            //city
                            DataCell(Center(
                                child:
                                    CustomText(text: clinics[index].address!))),
                            //number
                            DataCell(Center(
                                child: CustomText(
                                    text: clinics[index].phone.toString()))),
                            //name
                            DataCell(Center(
                                child: CustomText(
                              text: clinics[index].fullName!,
                            ))),
                          ],
                        ),
                      ),
        ...
        } else if (state is HisClinicsEmpty) {
          return const Center(
            child: Text('لا توجد عيادات مسجلة'),
          );
        }
